...
<div class="p-4">
    ...
    <ul>
        <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="my-2">
                <a href="<?php echo e($file['webViewLink']); ?>" target="_blank" class="text-blue-500">
                    <?php echo e($file['name']); ?>

                </a>
                <p>Type: <?php echo e($file['mimeType']); ?></p>
            </li>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </ul>
</div><?php /**PATH C:\CMGT\Jaar_2\TLE2_Startup\resources\views/alldocuments/documents-overview.blade.php ENDPATH**/ ?>