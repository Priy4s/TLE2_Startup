...
<?php $component->withAttributes([]); ?>
    ...
    <div class="mt-10">
        <form method="POST" action="<?php echo e(route('workspaces.store')); ?>" class="flex flex-col">
            <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\Senna\CMGT Jaar 2\TLE2_Startup\resources\views/workspaces/create.blade.php ENDPATH**/ ?>