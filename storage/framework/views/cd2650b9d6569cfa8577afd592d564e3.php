<section class="mt-10 mb-7 bg-articleBlue dark:bg-accentBlue rounded-2xl p-4 w-[50vw]">
    <header>
        ...
        <p class="mt-1 text-sm text-viridian dark:text-articleBlue">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.danger-button','data' => ['xData' => '','xOn:click.prevent' => '$dispatch(\'open-modal\', \'confirm-user-deletion\')','class' => 'mt-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['x-data' => '','x-on:click.prevent' => '$dispatch(\'open-modal\', \'confirm-user-deletion\')','class' => 'mt-4']); ?><?php echo e(__('Delete Account')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\Users\Senna\CMGT Jaar 2\TLE2_Startup\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>