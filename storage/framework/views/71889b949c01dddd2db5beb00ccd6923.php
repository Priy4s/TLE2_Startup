...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4">
            <a  class="underline text-sm text-accentBlue dark:text-articleBlue hover:text-viridian dark:hover:text-accentGreen rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="<?php echo e(route('login')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\Users\Senna\CMGT Jaar 2\TLE2_Startup\resources\views/auth/register.blade.php ENDPATH**/ ?>